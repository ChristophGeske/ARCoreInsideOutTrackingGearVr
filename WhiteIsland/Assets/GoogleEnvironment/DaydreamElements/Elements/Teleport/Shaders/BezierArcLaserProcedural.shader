...
// The texture of the line is generated procedurally.
Shader "DaydreamElements/Teleport/Bezier Arc Laser Procedural" {
  Properties {
  ...
  SubShader {
    ...
    Pass {
      ...
      v2f vert (appdata v) {
        ...
        // Remap the u to -1, 1. This will be used in the fragment shader.
        o.uv = half2(2.0 * v.uv.x - 1.0, v.uv.y);
      ...
      half4 frag (v2f i) : SV_Target {
        ...
        half uvX = 1 - abs(i.uv.x);
        col *= smoothstep(.8, 1, uvX) + 0.5 * uvX;
