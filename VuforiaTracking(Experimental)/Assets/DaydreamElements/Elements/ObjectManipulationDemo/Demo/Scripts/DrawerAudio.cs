...
namespace DaydreamElements.ObjectManipulation {
  ...
  /// Plays sound for interactive drawers.
  public class DrawerAudio : MonoBehaviour {
    public enum ObjectState{ None, Selected, Released }

    [Tooltip("The DrawerConstraint used by this script.")]
    public DrawerConstraint drawer;
    ...
    void OnValidate() {
      if (!drawer) {
        drawer = GetComponent<DrawerConstraint>();
      }
    }
